...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (interaction.options.getSubcommand() === 'all') {
            const rawRaritySelected = interaction.options.getString('rarity');
            console.log(`The rarity selected: ${rawRaritySelected}`);
            const rarityUsed = rawRaritySelected.toLowerCase();
